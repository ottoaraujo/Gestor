    ...
    public function get_settings_fields() {
        $settings_fields = array(
            ...
            'wptelegram_message' => array(
                ...
                array(
                    'name'     => 'inline_url_button',
                    'label'    => __( 'Inline Button', 'wptelegram' ),
                    'desc_tip' => __( 'Add Inline URL Button', 'wptelegram' ),
                    'desc'     => __( 'Add an inline clickable button for the post URL just below the message.', 'wptelegram' ),
                    'type'     => 'checkbox',
                    'sanitize_callback' => 'sanitize_text_field',
                ),
                array(
                    'name'              => 'inline_button_text',
                    'label'             => __( 'Inline button text', 'wptelegram' ),
            ...
            'wptelegram_notify' => array(
                ...
                array(
                    ...
                    'desc'     => sprintf( __( 'Use %s to let them connect their Telegram account', 'wptelegram' ), '<a href="' . esc_attr( 'https://wordpress.org/plugins/wptelegram-login' ) . '" target="_blank">WP Telegram Login & Register</a>' ),
